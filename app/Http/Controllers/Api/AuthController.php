...
class AuthController extends Controller
{
    ...
    public function verifierMatricule(Request $request)
    {
        ...
        if ($etudiantAutorise->niveau === $this->niveauLectureCode) {
            ...
            Mail::to($etudiantAutorise->email)->queue(
        ...
        Mail::to($etudiantAutorise->email)->queue(new ActivationCompteMail($etudiantAutorise));
    ...
    public function demanderReinitialisation(Request $request)
    {
        ...
        if ($user) {
            ...
            Mail::to($request->email)->queue(new ReinitialisationMotDePasseMail($token, $request->email));
        }
