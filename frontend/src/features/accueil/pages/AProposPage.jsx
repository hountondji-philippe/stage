...
import { getStatsPubliques } from "../api/accueilApi";
const VALEURS = [
...
export default function AProposPage() {
  ...
  return (
    <div className="relative">
      {loading && <LoadingScreen message="Chargement des statistiques..." />}
