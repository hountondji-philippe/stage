    ...
    <div className="flex flex-col items-start justify-between gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm lg:flex-row lg:items-center">
      <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto">
        ...
        <select
          ...
          className="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-600 outline-none focus:border-[var(--color-primary)]"
        >
      ...
      <div className="flex w-full items-center gap-3 lg:w-auto">
        <Button variant="outline" fullWidth onClick={onImportClick} className="lg:w-auto">
          <Upload size={18} />
          Importer
        </Button>
