 ...
 * - Mobile (< md) : devient le FOND plein écran de la page (position absolute) — logo épinglé
 *   en haut, texte épinglé en bas, tailles réduites. La page qui utilise ce composant doit être
 *   en `position: relative` et placer le formulaire par-dessus (z-10, avec sa propre box-shadow).
 *
...
export default function BrandPanel({ title, linkText, linkTo = "/connexion", badgeText }) {
  return (
    <div
      className="absolute inset-0 md:relative md:w-[45%] md:shrink-0 overflow-hidden flex flex-col p-6 sm:p-8 md:p-12 text-white"
